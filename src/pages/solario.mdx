...
<Image src={import("../images/solario/0.png")} alt="" />

No way bro thinks he can just steal syntax src

<Image src={import("../images/solario/1.png")} alt="" />

Wow, didn't know I could get warnings for bypassing "fuck"  
Can't pay 10 dollars for servers? Another retarded ban reason "i quit but im still in the background"
