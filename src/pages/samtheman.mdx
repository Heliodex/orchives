...
<div class="additions">
    ...
    <video controls>
    	<source
    		src="https://files.heliodex.cf/orchives/videos/samtheman/Genuine response to Aep.mkv"
    		type="video/mkv"
    	/>
    	<source
    		src="https://files.heliodex.cf/orchives/videos/samtheman/Genuine response to Aep.mp4"
    		type="video/mp4"
    	/>
