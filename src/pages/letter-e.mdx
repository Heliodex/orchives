...
<div class="notification">
	This document is a copy of [TheOfficialLetterE &ndash; The man behind
...
<h2 style="color:#666">WHO IS THEOFFICIALLETTERE??</h2>
...
TheletterE joined an old Roblox revival (real dumb) Called Kapish to purposefully exploit in it.<Image src={import("../images/letter-e/1.jpg")} alt="" />
