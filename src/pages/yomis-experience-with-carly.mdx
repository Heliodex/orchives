...
<em style="background:#3c78d8">doc by NiceYomi</em>
...
<strong style="font-size:1.5rem">
    ...
    <span style="background:blue">I remember when Marc published a group on a games page, and then a day later Mark exploded</span><br />
