...
<Image src={import("../images/the-608-documentary/226.png")} alt="" />
**<ins>Update:</ins> A new image has shown what 608 has deleted above.
Originally the bottom message (the message she deleted) was not in the above
image, but it has been found within a new image, which has been put above,
replacing the old one.** Context: Wafkee said "if you call me a traitor i'm
gonna block everyone" in OTGC after I posted my response. (Evidence in image
below)
<Image src={import("../images/the-608-documentary/227.png")} alt="" />
<Image src={import("../images/the-608-documentary/228.png")} alt="" />
...
<Image src={import("../images/the-608-documentary/229.png")} alt="" />
